...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "mod", CFGFLAG_SAVE|CFGFLAG_SERVER, "Game type (dm, tdm, ctf, lms, lts, mod)")
...
MACRO_CONFIG_STR(SvDatabaseName, sv_database_name, 64, "database.db", CFGFLAG_SAVE|CFGFLAG_SERVER, "The name of the database. (sqlite3)")
